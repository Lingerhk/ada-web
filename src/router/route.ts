			...
			},
			{
				...
				children: [
					...
					},
					{
						...
						component: () => import('/@/layout/routerView/parent.vue'),
						meta: {
							title: 'message.router.accountIndex',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
					...
					},
					{
						...
						meta: {
							title: 'message.router.systemIndex',
							isLink: '',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
						...
						children: [
							{
								...
								meta: {
									title: 'message.router.basicInfoIndex',
									isLink: '',
									isHide: false,
									isKeepAlive: true,
									isAffix: false,
							...
							},
							{
								path: '/system/sysTime',
								name: 'sysTimeIndex',
								component: () => import('/@/views/system/sysTime/index.vue'),
								meta: {
									title: 'message.router.sysTimeIndex',
									isLink: '',
									isHide: false,
									isKeepAlive: true,
									isAffix: false,
							...
							},
							{
								...
								meta: {
									title: 'message.router.licenseIndex',
									isLink: '',
									isHide: false,
									isKeepAlive: true,
									isAffix: false,
							...
							},
							{
								...
								name: 'diagnoseIndex',
								component: () => import('/@/views/system/diagnose/index.vue'),
								meta: {
									title: 'message.router.diagnoseIndex',
									isLink: '',
									isHide: false,
									isKeepAlive: true,
									isAffix: false,
